"""
Django settings for caims project.
...
WSGI_APPLICATION = 'caims.wsgi.application'
...
# Media files (user-uploaded content, e.g. generated QR codes)
MEDIA_URL = 'media/'
